...
void Sound_thread()
{
    while(true) {
        ...
        if(SoundA > 30000 && LightForSound.read_u16() < 10000) { //if the sound and light is above and below certain criteria then the alarm starts
            ...
            BSP_LCD_DisplayStringAt(0, LINE(8), (uint8_t *)c, CENTER_MODE);//display the amount of times it has been loud
        ...
        BSP_LCD_DisplayStringAt(0, LINE(5), (uint8_t *)b, CENTER_MODE);//display the amount of times it has been loud
